            ...
            <div class="container-fluid">
                ...
                <div class="card shadow mb-4">
                    <div class="card-header py-3">
                        <h6 class="m-0 font-weight-bold text-primary">Dane administratora</h6>
                    </div>
                    <div class="card-body">
                        <form:form modelAttribute="data" method="post">
                            <form:hidden path="id"/>
                            <div class="row">
                                <label for="email" class="col-2">Nazwa</label>
                                <form:input path="email" cssClass="col-2"/>
                            ...
                            <br>
                            <div class="row">
                                <label for="password" class="col-2">Hasło</label>
                                <form:input path="password" type="password" cssClass="col-2"/>
                                <span class="text-danger"><form:errors path="password"/></span>
                            </div>
                            <br>
                            <div class="row">
                                <label for="rePassword" class="col-2">Powtórz hasło</label>
                                <form:input path="rePassword" type="password" cssClass="col-2"/>
