                ...
                <div class="card shadow mb-4">
                    ...
                    <div class="card-body">
                        <form:form modelAttribute="data" method="post">
                            <form:hidden path="id"/>
                            <div class="row">
                                <label for="name" class="col-2">Nazwa</label>
                                <form:input path="name" cssClass="col-2"/>
                                <span class="text-danger"><form:errors path="name"/></span>
                            </div>
                            <br>
                            <div class="row">
                                <label for="description" class="col-2">Opis</label>
                                <form:input path="description" cssClass="col-2"/>
